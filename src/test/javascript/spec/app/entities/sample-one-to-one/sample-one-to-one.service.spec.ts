...
describe('Service Tests', () => {
    ...
    describe('SampleOneToOne Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SampleOneToOneService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/sample-one-to-ones';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SampleOneToOne', () => {

                let entity: SampleOneToOne;
                service.find(123).subscribe((_entity: SampleOneToOne) => {
                    entity = _entity;
                });
